...
void main() {
  runApp(coursesaligned());
}

// ignore: camel_case_types
class coursesaligned extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: Coursesaligned(title: 'Chemical Virtual Lab'),
    );
  }
}

class Coursesaligned extends StatefulWidget {
  Coursesaligned({Key? key, required this.title}) : super(key: key);

  final String title;

  @override
  _Coursesaligned createState() => _Coursesaligned();
}

class _Coursesaligned extends State<Coursesaligned> {
      ...
      home: Scaffold(
        ...
        body: Center(
          child: Column(
            ...
            children: [
              Text("This is Courses Aligned Page", style: TextStyle(fontFamily: 'OpenSans', fontWeight: FontWeight.w400, fontSize: 20))
            ],
            ...
            children: <Widget>[
              DrawerHeader(
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    color: Colors.white,
                    fontSize: 24, fontFamily: 'OpenSans', fontWeight: FontWeight.w400,
                  ),
                ),
              ),
              ListTile(
